...
class WPOAuth_Admin {
	...
	public function options_do_page() {
		...
		?>
		<div class="wrap">
			<h2>WP OAuth Server <small>(Community)</small>
					<small> | <?php echo _WO()->version; ?></small>
			</h2>
			<p><strong>The version as limited functionality but is completely free to use.</strong><br/>
				If you are looking for better security flow, unlimited clients, and all Grant Types, <a
					href="https://wp-oauth.com/platform/">Click Here</a> to upgrade to pro version.</strong></p>
			<form method="post" action="options.php">
				...
				<div id="wo_tabs">
						...
						<table class="form-table">
							<tr valign="top">
								...
								<td>
									...
									<p class="description">If the API is not enabled, it will present requests with an
					...
					<div id="advanced-configuration">
						...
						<p>Looking for a different Grant Type? <a href="https://wp-oauth.com/platform/">Download Pro
								Version</a>.</p>
						<table class="form-table">
							...
							<tr valign="top">
								...
								<td>
									<input type="checkbox" name="<?php echo $this->option_name ?>[auth_code_enabled]"
						...
						<table class="form-table">
							<tr valign="top">
								...
								<td>
									<input type="number" name="<?php echo $this->option_name ?>[client_id_length]"
							...
							<tr valign="top">
								...
								<td>
									<input type="checkbox" name="<?php echo $this->option_name ?>[enforce_state]"
